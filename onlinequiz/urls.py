...
urlpatterns = [
   ...
   # path('teacher/',include('teacher.urls')),
    ...
    path('admin_rank_board', views.admin_rank_board_view,name='admin_rank_board'),
    path('rank_board', views.rank_board_view,name='rank_board'),
    path('Submitted_exam', views.view_submitted_exam_view,name='Submitted_exam'),
    path('exam_status', views.check_exam_status,name='exam_status'),   
